...
public class DataFrame {
        ...
        try {
            ...
            if (null != br) {
                try {
                    ...
                    System.err.println("Caught IOException while closing reader: " + e.getMessage());
                    e.printStackTrace();
                }
            }
        }
    ...
    public GroupContainer groupby(String[] colnames) {
        ...
        return new GroupContainer(groupingResult, indicesOfBy);
    }
    ...
    public static void main(String[] argv) {
        ...
        DataFrame test = new DataFrame("/C:/Users/Jan/Documents/groupby.csv", types);
        ...
        DataFrame test2 = new DataFrame("/C:/Users/Jan/Documents/groubymulti.csv", types);
